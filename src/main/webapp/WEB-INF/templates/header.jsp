...
<div class="header">
	...
	<div class="nav">
		<ul style="float: left;">
			...
			<li><a href="<c:url value="cart/checkout"/>"><spring:message
						code="nav.checkout" /></a></li>
			<c:if test="${sessionScope.account eq null}">
				<li><a href="<c:url value="customer/register"/>"><spring:message
		...
		<ul style="float: right;">
			...
			<li><a href="?lang=nl"><img
					src="<c:url value="../resources/images/nl.gif"/>" alt="" title=""
					border="0" /></a></li>
		</ul>
	</div>
</div>